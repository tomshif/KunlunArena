...
class GoatEntClass:EntityClass
{
    var goatSoundAction=SKAction.playSoundFileNamed("quickBite.mp3", waitForCompletion: true)
  override init(theGame: GameClass, id: Int)
  {
      super.init(theGame: theGame, id: id)
      spriteNamePrefix="goat"
      headNum=3
      bodyNum=3
      tailNum=3
    ...
    override func attack() {
           ...
           {
               bodySprite.run(goatSoundAction)
           }
